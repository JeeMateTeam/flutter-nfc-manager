...
class NdefRecord {
  ...
  /// Constructs an instance containing application aar data.
  factory NdefRecord.createApplicationRecord(String buildName) {
    return NdefRecord(
      typeNameFormat: NdefTypeNameFormat.nfcExternal,
      type: Uint8List.fromList(utf8.encode("android.com:pkg")),
      identifier: Uint8List.fromList([]),
      payload: Uint8List.fromList(utf8.encode(buildName)),
    );
  }
